  ...
  return (
    <section id="skills" className="bg-[#1F2A44] py-32 text-white">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <h2 className="mt-4 text-center font-[family-name:var(--font-space)] text-5xl font-bold md:text-6xl">
          Skills
        </h2>

        <div className="mt-14 grid grid-cols-2 gap-x-6 gap-y-8 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6">
          {skills.map((skill) => (
            <div
              key={skill.name}
            ...
            >
              ...
              <p className="mt-2 text-sm text-slate-300 opacity-0 transition duration-300 group-hover:opacity-100">
                {skill.name}
              </p>
            </div>
          ))}
